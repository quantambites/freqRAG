...
from agent.agent import run_agent   # your custom agent


def query_agent(client: PageIndexClient, doc_id: str, prompt: str, verbose: bool = False) -> str:
    """
    Run document QA using custom Groq-based agent loop.
    """

    print("\n[Agent started]")
    print(f"\nQuery: {prompt}")

    answer = run_agent(client, doc_id, prompt)
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    question = "Explain techinical details and performance of attention residuals technique" #Explain Attention Residuals in simple language.
    print(f"\nQuestion: '{question}'")
